...
public class AirCompass extends Region {
    ...
    private Rotate                bearingRotate;
    
    Rotate getBearingRotate() {
   		return this.bearingRotate;
    }
    ...
    public AirCompass() {
        ...
        bearingRotate    = new Rotate(0, Rotate.Z_AXIS);
        init();
        initGraphics();
        registerListeners();
    }
    ...
    private void initGraphics() {
        ...
        bearingCanvas.getTransforms().addAll(this.getBearingRotate());
    ...
    private void handleControlPropertyChanged(final String PROPERTY) {
        if ("RESIZE".equals(PROPERTY)) {
            ...
            if (isAnimated()) {
                ...
                double current = this.getBearingRotate().getAngle();
                ...
                KeyValue kvBearingAngleBegin = new KeyValue(bearingAngle, this.getBearingRotate().getAngle(), Interpolator.EASE_IN);
                KeyValue kvBearingCanvasRotateBegin = new KeyValue(this.getBearingRotate().angleProperty(), this.getBearingRotate().getAngle(), Interpolator.EASE_IN);

                KeyValue kvBearingAngleEnd = new KeyValue(bearingAngle, rotationAngle, Interpolator.EASE_OUT);
                KeyValue kvBearingCanvasRotateEnd = new KeyValue(this.getBearingRotate().angleProperty(), rotationAngle, Interpolator.EASE_OUT);
            	...
            	this.getBearingRotate().setAngle(-target);
    ...
    private void resize() {
        ...
        if (width > 0 && height > 0) {
            ...
            bearingRotate.setPivotX(size * 0.5);
            bearingRotate.setPivotY(size * 0.5);
