package net.akehurst.app.dotEditor.application.web.vertx.angular;
...
public class DotEditorVertxAngularApplication extends ApplicationAbstract {

	public DotEditorVertxAngularApplication(final String id) {
		super(id);
	}
