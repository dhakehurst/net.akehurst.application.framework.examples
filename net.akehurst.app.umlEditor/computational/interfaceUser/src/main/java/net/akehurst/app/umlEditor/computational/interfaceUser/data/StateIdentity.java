...
@DataType
public class StateIdentity extends AbstractDataType {
	private static Pattern valid = Pattern.compile("[a-zA-Z_][a-zA-Z_0-9]*");

	public StateIdentity(final String value) throws UserException {
		super(value);
		if (StateIdentity.valid.matcher(value).matches()) {
			// ok
		} else {
