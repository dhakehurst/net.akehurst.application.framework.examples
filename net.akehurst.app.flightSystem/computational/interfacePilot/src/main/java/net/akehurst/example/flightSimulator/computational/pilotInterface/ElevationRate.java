...
public class ElevationRate {

	/**
	 * Elevation Rate (percentage)
	 * will clip value to the range -100 <= value <= +100
	 * 
	 * @param value
	 */
	public ElevationRate(double value) {
	...
	public boolean equals(Object arg) {
		if (arg instanceof ElevationRate) {
			ElevationRate other = (ElevationRate)arg;
	...
	public String toString() {
		return "ElevationRate{"+this.asPrimitive()+"%}";
	}
}
