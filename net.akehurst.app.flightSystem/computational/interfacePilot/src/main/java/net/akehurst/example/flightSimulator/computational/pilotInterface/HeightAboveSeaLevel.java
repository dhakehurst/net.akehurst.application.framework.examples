...
public class HeightAboveSeaLevel {
	...
	/**
	 * HeightAboveSeaLevel (meters)
	 * will clip value to the range 0 <= value <= 100000
	 * 
	 * @param value
	 */
	public HeightAboveSeaLevel(double value) {
	...
	public boolean equals(Object arg) {
		if (arg instanceof HeightAboveSeaLevel) {
			HeightAboveSeaLevel other = (HeightAboveSeaLevel)arg;
	...
	public String toString() {
		return "HeightAboveSeaLevel{"+this.asPrimitive()+"m}";
	}
}
