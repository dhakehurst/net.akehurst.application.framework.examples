...
public class AttitudeSensorYawSample {

	/**
	 * AttitudeSensorYawSample
	 * 
	 * 
	 * @param value
	 */
	public AttitudeSensorYawSample(double value) {
	...
	public boolean equals(Object arg) {
		if (arg instanceof AttitudeSensorYawSample) {
			AttitudeSensorYawSample other = (AttitudeSensorYawSample)arg;
	...
	public String toString() {
		return "AttitudeSensorYawSample{"+this.asPrimitive()+" radians}";
	}
}
