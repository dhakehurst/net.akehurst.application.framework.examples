...
public class RudderPosition {
	...
	/**
	 * RudderPosition Percentage
	 * will clip value to the range -100 <= value <= +100
	 * 
	 * @param value
	 */
	public RudderPosition(double value) {
	...
	public boolean equals(Object arg) {
		if (arg instanceof RudderPosition) {
			RudderPosition other = (RudderPosition)arg;
	...
	public String toString() {
		return "RudderPosition{"+this.asPrimitive()+"%}";
	}
}
