...
public class RadarAltitudeSensor implements Runnable, IHardwareRegister {

	public RadarAltitudeSensor(double sensingRatePerSecond) {
	...
	void simulateSampleAltitude() {
		double d = this.environment.getAltitude().asPrimitive();
	...
	public void start() {
		this.thread = new Thread(this, "RadarAltitudeSensor");
		this.thread.start();
	}
