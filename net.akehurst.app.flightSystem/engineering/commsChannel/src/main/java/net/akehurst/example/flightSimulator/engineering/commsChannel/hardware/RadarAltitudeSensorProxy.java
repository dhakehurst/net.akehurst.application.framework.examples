...
public class RadarAltitudeSensorProxy implements IRadarAltitudeSensor {

	public RadarAltitudeSensorProxy() {
	}
	...
	// ---------- IAirPressureSensor ----------
	@Override
	public RadarAltitudeSensorSample readValue() {
		...
		RadarAltitudeSensorSample sample = new RadarAltitudeSensorSample(value);
		return sample;
	}
